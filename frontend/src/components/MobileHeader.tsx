...
export default function MobileHeader() {
  ...
  return (
    <header className="sm:hidden sticky top-0 left-0 right-0 h-[60px] bg-background/90 backdrop-blur-md border-b border-border z-40 flex items-center justify-between px-4">
      {/* Brand Logo */}
