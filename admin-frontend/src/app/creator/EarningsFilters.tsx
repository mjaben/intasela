    ...
    <div className="flex flex-col sm:flex-row gap-4 mb-6">
      ...
      <div className="relative flex-1">
        ...
        <input 
          ...
          placeholder="Search by creator username or name..."
        ...
        {isFilterOpen && (
          <div className="absolute right-0 mt-2 w-64 bg-brand-card border border-brand-border/50 rounded-xl shadow-2xl z-50 animate-in fade-in slide-in-from-top-2">
            <div className="p-4 space-y-4">
              {/* Status Group */}
              <div>
                <label className="text-[11px] font-semibold uppercase text-gray-500 tracking-wider mb-2 block">Transaction Status</label>
                <div className="flex flex-col gap-2 text-sm text-gray-300">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer relative">
                    <div className="relative flex items-center justify-center">
                      <input type="radio" name="status" checked={status === "completed"} onChange={() => setStatus("completed")} className="appearance-none w-4 h-4 rounded-full border border-gray-600 bg-brand-bg checked:border-[4px] checked:border-brand transition-all cursor-pointer" />
                    </div>
                    Completed
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer relative">
                    <div className="relative flex items-center justify-center">
                      <input type="radio" name="status" checked={status === "pending"} onChange={() => setStatus("pending")} className="appearance-none w-4 h-4 rounded-full border border-gray-600 bg-brand-bg checked:border-[4px] checked:border-brand transition-all cursor-pointer" />
                    </div>
                    Pending
                  </label>
                </div>
